...
(defun my-color-theme ()
  ...
  (color-theme-install
   '(my-color-theme
     ...
     (magit-diff-add ((t (:background "black" :foreground "yellow"))))
     (magit-diff-del ((t (:background "DarkGray" :foreground "black"))))
     (magit-log-head-label-bisect-bad ((t (:background "IndianRed1" :foreground "black"))))
     (magit-log-tag-label ((t (:background "DarkYellow" :foreground "black"))))
     (zmacs-region ((t (:background "blue")))))))
(add-to-list 'color-themes '(my-color-theme  "dark simple" "rlonstein"))
