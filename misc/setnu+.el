...
;; Version: 21.0
;; Last-Updated: Mon Jul 04 10:25:30 2005
;;           By: dradams
;;     Update #: 134
;; Keywords:
...
This has no effect if function `fit-frame' is not defined."
  :type 'boolean :group 'setnu :group :fit-frame)
